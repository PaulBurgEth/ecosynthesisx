...
// Sentry wrap. Runtime capture is gated on the DSN env vars (no-op if unset); no auth token needed to
// build. disableLogger omitted (deprecated + unsupported under Turbopack, which Vercel uses for Next 16).
