...
export const impactProducts = [
  ...
  },
  {
    ...
    status: "Collection In Development",
    statusColor: "yellow",
    description: "Our second partner for Real-World Impact tokenization. We are currently developing the framework to verify and tokenize their community gardens and sustainability education workshops, expanding our dMRV scope beyond just waste management.",
    links: {
      telegram: "https://web.telegram.org/a/#-1002094600518",
      website: "https://ecothailand.org",
    },
    buttonText: "Visit Partner Website",
    stats: [
